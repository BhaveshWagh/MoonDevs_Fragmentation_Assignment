...
const BurnStatsContainer = () => {
    ...
    const statsSupplies = suppliesBurnstats;
    ...
    <div>
      <div className="top_bar">
        ...
        <AppChip
          ...
          startIcon={`/images/token/${walletChainBurnstats?.nativeCurrency?.symbol}.svg`}
        ></AppChip>
        <AppExtLink
      ...
      <div className="supply_label_list">
        <div>
          ...
          <p className="supply_value">
            <AppIcon
              size={1.25}
              url={`/images/token/${walletChainBurnstats?.nativeCurrency?.symbol}.svg`}
              fill={IconFilter.unset}
              margin={0}
            />
            {numberWithCommas(
        ...
        <div>
          ...
          {allSupplies
            .filter((s) => s.chainId != walletChainBurnstats?.id)
            .map((s: any) => (
